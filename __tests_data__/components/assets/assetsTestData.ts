...
export function getAssets(): Array<Asset> {
  return [
    {
      assignedUserIds: [1, 2, 3],
      companyId: 1,
      healthHistory: [
        { status: "inOperation", timestamp: "2022-12-01T00:00:00.000Z" },
        { status: "inDowntime", timestamp: "2022-12-08T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-15T00:00:00.000Z" },
        { status: "inAlert", timestamp: "2022-12-22T00:00:00.000Z" },
        { status: "unplannedStop", timestamp: "2022-12-29T00:00:00.000Z" },
      ],
      healthscore: 70,
      id: 1,
      image:
    ...
    },
    {
      ...
      healthHistory: [
        { status: "inOperation", timestamp: "2022-12-01T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-08T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-15T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-22T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-29T00:00:00.000Z" },
      ],
      healthscore: 73.7,
      id: 2,
      image:
      ...
      name: "Motor H12D-1",
      sensors: ["IBS1636"],
      specifications: { maxTemp: 53, power: 1.5, rpm: null },
      status: "inDowntime",
      unitId: 1,
    },
    {
      ...
      name: "Motor H12D-3",
      sensors: ["JVC1134"],
      specifications: { maxTemp: 57, power: 0, rpm: 1750 },
      status: "inOperation",
      unitId: 1,
    },
    {
      ...
      healthHistory: [
        { status: "inOperation", timestamp: "2022-12-01T00:00:00.000Z" },
        { status: "plannedStop", timestamp: "2022-12-08T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-15T00:00:00.000Z" },
        { status: "plannedStop", timestamp: "2022-12-22T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-29T00:00:00.000Z" },
      ],
      healthscore: 88.3,
      id: 4,
      ...
      name: "Motor H12D-2",
      sensors: ["LZY5230"],
      specifications: { maxTemp: 55, power: 0, rpm: 1740 },
      status: "inOperation",
      unitId: 2,
    },
    {
      ...
      name: "Fan D21",
      sensors: ["NBX2120"],
      specifications: { maxTemp: 64, power: 1.5, rpm: 840 },
      status: "inAlert",
      unitId: 2,
    },
    {
      ...
      healthHistory: [
        { status: "inOperation", timestamp: "2022-12-01T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-08T00:00:00.000Z" },
        { status: "plannedStop", timestamp: "2022-12-15T00:00:00.000Z" },
        { status: "plannedStop", timestamp: "2022-12-22T00:00:00.000Z" },
        { status: "inOperation", timestamp: "2022-12-29T00:00:00.000Z" },
      ],
      healthscore: 91.2,
      ...
      name: "Fan D22",
      sensors: ["MOE1378"],
      specifications: { maxTemp: 58, power: 1.5, rpm: 832 },
      status: "inDowntime",
      unitId: 2,
    },
  ];
